  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-8
        ...
        p.mt-3(data-aos="fade-left") Es importante tener presente que son los clientes quienes determinan si la organización cumple o no cumple con las promesas divulgadas, porque para ellos cumplir con lo prometido es:
        ...
        p(data-aos="fade-left") Según estudios, un 93 % de los consumidores manifiestan incumplimiento en su adquisición, lo que significa que muy posiblemente la mayoría de las organizaciones están trabajando soportados más sobre su propia percepción que en la del cliente.
        p.mb-0(data-aos="fade-left") A continuación, se plantean algunos ejemplos de promesas al cliente y cómo se puede caer fácilmente en el incumplimiento.     

    .bg1-tema1
      .row.justify-content-center.mt-5
        .col-lg-4.col-sm-8.mb-lg-0.mb-4(data-aos="fade-right")
          .tarjeta-numerada.color-primario.p-5.h-100(style="border-color: #81D4FA !important")
        ...
        .col-lg-4.col-sm-8.mb-lg-0.mb-4(data-aos="flip-up")
          .tarjeta-numerada.color-secundario.p-5.h-100.bgColor_numeral
        ...
        .col-lg-4.col-sm-8(data-aos="fade-left")
          .tarjeta-numerada.color-primario.p-5.h-100(style="border-color: #4CEBFF !important")
    ...
    .row.mt-5
      .col-lg-7
        .list.mb-3(data-aos="fade-down")
          ...
          .list__txt
            h4.mb-0.tv.margin-icon <span style='border-bottom: 2px solid #00BCD4'>Tiempos de entrega</span>

    .row.justify-content-center.align-items-center.mt-3
      p(data-aos="fade-left") El tiempo de entrega o <i>lead time</i> está sujeto al proceso de distribución del producto, donde se mide el tiempo transcurrido desde la solicitud de este hasta el cliente final. 
      p.mb-0(data-aos="fade-left") Uno de los grandes objetivos de las empresas es lograr la excelencia en la atención, por lo cual es necesario contar con un proceso de logística que garantice la entrega de los productos en el tiempo acordado y en óptimas condiciones de calidad, teniendo presente que un porcentaje significativo de los compradores consideran de suma importancia los tiempos de entrega de los productos y por ende un mal servicio en este aspecto provoca que estos cambien de marca o proveedor.
    ...
    .row.justify-content-center.align-items-center.mt-3
      ...
      .col-lg-8
        ...
        ul.lista-ul--color.lista-ul--separador.fa-ul2(style="border-bottom: dotted 2px #B0C0D2;")
          ...
          li(data-aos="fade-left")
            i.fas.fa-atom(style='color: #7E5EE3') 
            | Usar las tecnologías que permiten ubicar los transportadores en tiempo real.
          li(data-aos="fade-left")
            i.fas.fa-atom(style='color: #7E5EE3') 
            | Analizar y tener presente los indicadores de gestión de servicio al cliente.
          li(data-aos="fade-left")
            i.fas.fa-atom(style='color: #7E5EE3') 
            | Capacitar el personal constantemente en servicio al cliente.
        ...
        .list.mb-3(data-aos="fade-down")
          .list__item
            .list__item__icon
              img(src='@/assets/curso/temas/tema1/icon1.svg', alt='Imágen decorativa')
          .list__txt
            h4.mb-0.tv.margin-icon <span style='border-bottom: 2px solid #00BCD4'>Volúmenes de despacho</span>
    
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mt-3(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema1/img3.png')})`}" data-aos="fade-right"
      )
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        p.mb-0 Como se vio anteriormente, la calidad de los productos y la velocidad en la distribución marcan significativamente la decisión de fidelización de los clientes y es ahí donde se debe contar con suficiente flujo interno de producto, cuantía de referencias, rotación, entre otras, que permita comprometerse con el cliente y además anticiparse a eventos futuros.
