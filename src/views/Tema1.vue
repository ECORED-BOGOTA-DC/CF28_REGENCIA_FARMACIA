  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-8
        ...
        p(data-aos="fade-left") A continuación, se plantean algunos ejemplos de promesas al cliente y cómo se puede caer fácilmente en el incumplimiento.     
